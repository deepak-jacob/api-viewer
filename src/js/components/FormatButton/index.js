...
//thunk Observable
export const FormatButtonObservable = () =>
	Observable.merge(PrimaryButtonObservable(), FormatChangeButtonObservable())

export const PrimaryButtonObservable = () =>
	Observable
...
export const FormatChangeButtonObservable = () =>
	Observable
